...
object DatabaseModule {
    ...
    private val MIGRATION_12_13 = object : Migration(12, 13) {
        override fun migrate(db: SupportSQLiteDatabase) {
            addNullableColumnIfMissing(db, "loans", "closedAt", "INTEGER")
        }
    }
    ...
    private val MIGRATION_13_14 = object : Migration(13, 14) {
        override fun migrate(db: SupportSQLiteDatabase) {
            ...
            db.execSQL(
                "CREATE UNIQUE INDEX IF NOT EXISTS `index_loan_payments_loanId_paymentMonth` ON `loan_payments` (`loanId`, `paymentMonth`)"
            )
        }
    }
